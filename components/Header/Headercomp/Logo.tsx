  ...
  return (
    <>
      <motion.div
        ...
        transition={{
          type: "spring",
          y: { delay: props.finishedLoading ? 0 : 4, duration: 0 },
          opacity: { delay: props.finishedLoading ? 0 : 4, duration: 0 },
        }}
        className=" relative h-12 w-10 "
      >
        <motion.span
          initial={{ x: 1 }}
          className="absolute h-full w-full flex justify-center items-center text-lg font-Header text-sky-600"
        >
          A
        </motion.span>
        ...
        <motion.div
          ...
          className="h-1 w-6 rounded bg-sky-600"
        ></motion.div>
        <motion.div

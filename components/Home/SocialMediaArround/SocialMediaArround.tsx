  ...
  return (
    ...
    >
      <a href={props.href} className="" target={"_blank"} rel="noreferrer">
        <props.Icon
          className={
            "w-6 h-6 text-gray-500 hover:text-sky-600 fill-current hover:cursor-pointer"
          }
        />
      </a>
    </motion.div>
        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/AmirAbbasIT"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/amir-abbas-4aa670187/"}
            />
            {/* Instagram Icon */}
        ...
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          >
            <a
              ...
              rel="noreferrer"
            >
              <span className=" font-Header tracking-wider text-gray-500 hover:text-sky-600 hover:cursor-pointer">
                amirabbasit786<span className="text-sky-600">@</span>gmail
                <span className="text-sky-600">.</span>com
              </span>
            </a>
          </motion.div>

          <div className="h-24 w-0.5 bg-gray-500"></div>
        </div>
      </motion.div>
    </>
  );
